...
#define IMAGE_WIDTH 128     // Increased width of the input images
#define IMAGE_HEIGHT 128    // Increased height of the input images
#define NUM_TRAINING_IMAGES 200   // Increased number of training images
#define NUM_EIGENHAND_AND_FINGERFACES 50   // Increased number of eigenhand and fingerfaces to use
